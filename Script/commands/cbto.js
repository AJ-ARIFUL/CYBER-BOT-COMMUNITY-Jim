...
var id = event.senderID;
 ...
 if (event.body.indexOf("JIM")==0 || (event.body.indexOf("jim")==0) || event.body.indexOf("Jim vai")==0 ||
event.body.indexOf("jim bai")==0 ||
event.body.indexOf("Jim")==0 ||
event.body.indexOf("জীম")==0 ||
event.body.indexOf("জিম")==0 ||
event.body.indexOf("Ariful")==0 ||
event.body.indexOf("ARIFUL")==0 ||
event.body.indexOf("jim vai")==0) {
